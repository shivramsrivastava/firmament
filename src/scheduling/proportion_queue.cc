...
void Queue_Proportion::SetDeservedResource(float cpuRes, uInt64_t memoryRes, uInt64_t epheRes) {
...
void Queue_Proportion::SetAllocatedResource(float cpuRes, uInt64_t memoryRes, uInt64_t epheRes) {
...
void Queue_Proportion::SetRequestedResource(float cpuRes, uInt64_t memoryRes, uInt64_t epheRes) {
...
void Queue_Proportion::AddAllocatedResource(float cpuRes, uInt64_t memoryRes, uInt64_t epheRes){
	allocated_resource_.cpu_resource += cpuRes;
	allocated_resource_.memory_resource += memoryRes;
	allocated_resource_.ephemeral_resource += epheRes;
...
void Queue_Proportion::AddRequestedResource(float cpuRes, uInt64_t memoryRes, uInt64_t epheRes) {
	
	requested_resource_.cpu_resource += cpuRes;
	requested_resource_.memory_resource += memoryRes;
	requested_resource_.ephemeral_resource += epheRes;
}
void Queue_Proportion::DeductAllocatedResource(float cpuRes, uInt64_t memoryRes, uInt64_t epheRes) {
	
	allocated_resource_.cpu_resource -= cpuRes;
	allocated_resource_.memory_resource -= memoryRes;
	allocated_resource_.ephemeral_resource -= epheRes;
}
void Queue_Proportion::DeductRequestedResource(float cpuRes, uInt64_t memoryRes, uInt64_t epheRes) {
