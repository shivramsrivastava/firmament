...
void KnowledgeBase::AddToResourceStatsAgg(ResourceStatsAggregate &resStatus){
  resource_stats_.resource_capcity.cpu_resource += resStatus.resource_capcity.cpu_resource;
  resource_stats_.resource_capcity.memory_resource += resStatus.resource_capcity.memory_resource;
  resource_stats_.resource_capcity.ephemeral_resource += resStatus.resource_capcity.ephemeral_resource;

	resource_stats_.resource_allocatable.cpu_resource += resStatus.resource_allocatable.cpu_resource;
	resource_stats_.resource_allocatable.memory_resource += resStatus.resource_allocatable.memory_resource;
	resource_stats_.resource_allocatable.ephemeral_resource += resStatus.resource_allocatable.ephemeral_resource;
}
void KnowledgeBase::DeductFromResourceStatsAgg(ResourceStatsAggregate &resStatus) {
  resource_stats_.resource_capcity.cpu_resource -= resStatus.resource_capcity.cpu_resource;
  resource_stats_.resource_capcity.memory_resource -= resStatus.resource_capcity.memory_resource;
  resource_stats_.resource_capcity.ephemeral_resource -= resStatus.resource_capcity.ephemeral_resource;
