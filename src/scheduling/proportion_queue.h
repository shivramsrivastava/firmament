...
class Queue_Proportion {
	...
	public :
	  ...
	  void AddRequestedResource(float cpuRes, uInt64_t memoryRes, uInt64_t epheRes);
		void DeductAllocatedResource(float cpuRes, uInt64_t memoryRes, uInt64_t epheRes);
		void DeductRequestedResource(float cpuRes, uInt64_t memoryRes, uInt64_t epheRes);
